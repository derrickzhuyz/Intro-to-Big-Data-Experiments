...
TRAINDATAPATH = 'file:///home/hadoop/Experiment/Ex4_CustomerForecast/src/train_after.csv'
TESTDATAPATH = 'file:///home/hadoop/Experiment/Ex4_CustomerForecast/src/test_after.csv'
# TESTDATAPATH = "/ex4/dataset/test_after.csv"
...
def predict(Iterations=1000,threshold=-90000):
    ...
    # 计算精度
    accuracy = scoreAndLabels.filter(lambda l:  l[0] == 1).count() / test.count()
    return accuracy
